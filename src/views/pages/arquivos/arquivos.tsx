                ...
                <div className={style.ContentContainer}>
                    <div className={style.Main}>
                        <div className={style.Title}>
                            ...
                            <h1>Home /</h1>
                            <Folders className={style.IconPage} size={32} weight='duotone' />
                            <h1>Arquivos</h1>
                        </div>
                                ...
                                <div className={style.TimeLine}>
                                    ...
                                    <Timeline style={{ marginTop: '5%' }}
                                        items={[
                                            ...
                                            {
                                                children: 'Lorem ipsum etur adipiscing elit dolor sit amet, consect.',
                                            },
                                            {
                                                children: 'Lorem similique esse sit corrupti aspernatur voluptate. Dicta, enim? Omnis doloribus nostrum minus error.',
                                            },
                                            {
                                                children: 'Lorem bitis deserunt iure adipisci ipsu',
                                            },
                                            {
                                                children: 'Lorem intum solelis elit, blandit ullamcorper accumsan vitae, pulvinar in dui.',
                                            },
                                            {
                                                children: 'Lorem entum dolor quis dignissim. Proin porttitor venenatis malesuada. Vivalis arc',
                                            },
